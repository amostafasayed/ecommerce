    ...
    <div class="footerContent container">
        <div class="row" style="border-bottom: 1px solid #989898;">
            ...
            <div class="items col-lg-2 col-md-4 col-xs-12">
                ...
                <ul>
                    <li>
                        <a href="https://facebook.com/billboardbd" target="_blank">
                            <i class="fa fa-facebook"></i>Facebook
                        </a>
                    </li>
                    <li>
                        <a href="https://twitter.com/billboardbd" target="_blank">
                            <i class="fa fa-tumblr"></i>Twitter
                        </a>
                    </li>
                    <li>
                        <a href="https://youtube.com/billboardbd" target="_blank">
...
{{--                    <li><a href="#"><i class="fa fa-rss"></i>Blog</a></li>--}}
        ...
        <div class="row">
            <div class="col-md-12 bottom-text">
                 <small class="">
                     © FireBidders.com . All rights reserved. Shoppers based in the Bangladesh cannot participate on FireBid
                 </small>
